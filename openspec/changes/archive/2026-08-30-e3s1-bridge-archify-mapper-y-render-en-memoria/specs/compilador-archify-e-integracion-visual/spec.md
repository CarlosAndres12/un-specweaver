...
**Objetivo:** mapear estado vivo a JSON Archify y renderizar HTML/SVG en memoria con sandbox y degradado. Cubre paso 5 del plan. **Incluye:** `src/dashboard/archify-bridge.mjs`, `GET /api/projects/:id/diagram`, visor Archify reactivo. **Depende de:** Epic 1, 2. **Bloquea a:** Epic 4 (visor).
